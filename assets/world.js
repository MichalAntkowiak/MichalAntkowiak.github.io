...
MAWORLD.buildGroundWorld=function(THREE,opts){
  ...
  towerGreen(-34,-108,9,9,52); towerCurved(-8,-118,5,56,'spiral',1.18);
  towerGreen(22,-104,10,9,44); towerGreen(58,-116,9,10,38);
  towerCurved(-66,-100,4.4,40,'drop',1.05); towerGreen(84,-96,9,9,34);
  towerGreen(-92,-92,8,9,30);
  heroSpots.push({x:44,z:-88,kind:'drop',s:.8},{x:14,z:-86,kind:'spiral',s:.72});
